...
if __name__ == '__main__':
    ...
    for earth_image in name_files:
        ...
        img_gray = np.array(((img_gray/ img_gray.max()) ** 0.2) * 255, dtype=np.uint8)
        ...
        plt.tight_layout()
        fig.savefig(folder + "filtered_{}.png".format(earth_image), dpi=500)

        cv2.imwrite(folder + f'gray_{earth_image}.png', 255-img_gray)
        plt.close()